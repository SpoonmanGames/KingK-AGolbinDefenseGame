...
namespace ScreenManager.StateControl
{
    ...
    public class InputState
    {
        ...
        public bool IsLeft(PlayerIndex? controllingPlayer)
        {
            ...
            //Acepta Keys.Left
            return IsContinuousKeyPress(Keys.Left, controllingPlayer, out playerIndex);
        }
        ...
        public bool IsRight(PlayerIndex? controllingPlayer)
        {
            ...
            //Acepta Keys.Right
            return IsContinuousKeyPress(Keys.Right, controllingPlayer, out playerIndex);
        }
        ...
        public bool IsEscape(PlayerIndex? controllingPlayer) {
            PlayerIndex playerIndex;
